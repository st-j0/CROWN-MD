module.exports = (m, env) => {
   ...
   if (setting) {
      ...
      if (!('sk_author' in setting)) setting.sk_author = '© mrlitA'
      ...
      if (!('msg' in setting)) setting.msg = 'Salut +tag 🙂\nJe suis un système automatisé (WhatsApp Bot) qui peut aider à faire quelque chose, rechercher et obtenir des données/informations uniquement via WhatsApp.\n\n◦ *Database* : +db\n◦ *Library* : Baileys v+version\n◦ *Rest API* : https://andymrlit.xyz\n◦ *Source* : https://github.com/mrlit-a/crown-md\n\nSi vous trouvez une erreur ou souhaitez mettre à niveau le plan premium, contactez le propriétaire.'
      if (!isNumber(setting.style)) setting.style = 4
      if (!('cover' in setting)) setting.cover = 'https://i.imgur.com/M8S9JjL.jpeg'
      if (!('link' in setting)) setting.link = 'https://chat.whatsapp.com/LZojfM2mEFL9ibw9r7Yn0K'
   } else {
      global.db.setting = {
         autodownload: false,
         debug: false,
         ...
         msg: 'Salut +tag 🙂\nJe suis un système automatisé (WhatsApp Bot) qui peut aider à faire quelque chose, rechercher et obtenir des données/informations uniquement via WhatsApp.\n\n◦ *Database* : +db\n◦ *Library* : Baileys v+version\n◦ *Rest API* : https://andymrlit.xyz\n◦ *Source* : https://github.com/mrlit-a/crown-md\n\nSi vous trouvez une erreur ou souhaitez mettre à niveau le plan premium, contactez le propriétaire.',
         style: 4,
         cover: 'https://i.imgur.com/M8S9JjL.jpeg',
         link: 'https://chat.whatsapp.com/LZojfM2mEFL9ibw9r7Yn0K'
      }
   }
}
